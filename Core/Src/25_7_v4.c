...
int arr_to_int(char arr[], int size) {
	int result;
	switch(size)
	{
		case 1:
		...
		switch (count_state_lcd % 7) {
			...
			case 4: {
				...
				switch(flag_number)
				{
					...
					break;
					case 11:
						if(arr_to_int(data_qtr,strlen(data_qtr)) <= 4095 && arr_to_int(data_qtr,strlen(data_qtr)) >=0)
						{
							lcd_clear();
							lcd_put_cur(0, 0);
							lcd_send_string("OK");
							nguong_adc_quang_tro = arr_to_int(data_qtr,strlen(data_qtr));
							flag_chuyen_lcd =1;
							count_state_lcd =5;
							flag_ngat_keypad =1;
							HAL_Delay(1000);
				...
				switch(flag_number)
				{
					...
					case 11:
						if(arr_to_int(data_qtr,strlen(data_qtr)) <= 4095 && arr_to_int(data_qtr,strlen(data_qtr)) >=0)
						{
							...
							lcd_put_cur(0, 0);
							lcd_send_string("OK");
							nguong_adc_do_am_dat = arr_to_int(data_qtr,strlen(data_qtr));
							flag_chuyen_lcd =1;
							count_state_lcd =6;
							flag_ngat_keypad =1;
							HAL_Delay(1000);
			...
			case 6:
			{
				...
				switch(flag_number)
				{
					...
					break;
					case 11:
						if(arr_to_int(data_qtr,strlen(data_qtr)) <= 100 && arr_to_int(data_qtr,strlen(data_qtr)) >=0)
						{
							lcd_clear();
							lcd_put_cur(0, 0);
							lcd_send_string("OK");
							nguong_nhiet_do = arr_to_int(data_qtr,strlen(data_qtr));
							flag_chuyen_lcd =1;
							count_state_lcd =7;
							flag_ngat_keypad =1;
							HAL_Delay(1000);
