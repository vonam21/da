...
void HAL_UART_RxCpltCallback(UART_HandleTypeDef *huart) {
  ...
  if (huart->Instance == huart1.Instance) {
    if (flag_check_OK) {
      ...
      if (*dataRX == 'K') {
        if (strcmp((const char *)save_data_chuoi_OK,
                   (const char *)so_sanh_chuoi_OK) == 0) {
          flag_pass = 1;
        }
      }
      //			HAL_UART_Transmit(huart, dataTX, strlen(dataTX),
    ...
    if (flag_check_CMQTT) {
      ...
      if (strcmp((const char *)save_data_chuoi_CMQTT,
                 (const char *)so_sanh_chuoi_CMQTT) == 0) {
    ...
    if (flag_check_PB_DONE) {
      ...
      if (strcmp((const char *)save_data_chuoi_PB_DONE,
                 (const char *)so_sanh_chuoi_PB_DONE) == 0) {
        HAL_UART_Transmit(huart, dataTX1, strlen((const char *)dataTX1), 10);
      }
      HAL_UART_Receive_IT(huart, dataRX, sizeof(dataRX));
    }
    if (flag_check_RX_PAYLOAD) {
      if (flag_pass_RX_PAYLOAD == 0) {
        ...
        if (strcmp((const char *)save_data_chuoi_RX_PAYLOAD,
                   (const char *)so_sanh_chuoi_RX_PAYLOAD) == 0) {
          flag_pass_RX_PAYLOAD = 1;
          __HAL_TIM_SET_COUNTER(&htim1, 0);
          //				HAL_UART_Transmit(huart, dataTX1, strlen(dataTX1),
          //10);
        }
      }
      if (flag_pass_RX_PAYLOAD) {
        if (flag_pass_RX_PAYLOAD_next) {
          ...
          if (*dataRX == '\n') {
            ...
            sscanf((const char *)message, "%d %d %d %d %d %d %d", &led, &quat,
        ...
        if (strcmp((const char *)save_data_chuoi_RX_PAYLOAD_DATA,
                   (const char *)so_sanh_chuoi_xuong_dong) == 0) {
...
void HAL_GPIO_EXTI_Callback(uint16_t GPIO_Pin) {
  if (GPIO_Pin == GPIO_PIN_2) {
    ...
    if (state_ngat2 == 1) {
      ...
      //th�?i gian hiện tại 				if ((currentTime - lastDebounceTime) >
      //debounceDelay_mode)
      //				{
      ...
      //						state_ngat1=1;
      //						GPIO_InitTypeDef
      //GPIO_InitStruct = {0}; 						GPIO_InitStruct.Pin = GPIO_PIN_2;
      //						GPIO_InitStruct.Mode =
      //GPIO_MODE_IT_FALLING; 						GPIO_InitStruct.Pull = GPIO_PULLUP;
      //						HAL_GPIO_Init(GPIOA,
      //&GPIO_InitStruct);
      //					}
  ...
  if (GPIO_Pin == GPIO_PIN_3) {
    ...
    if (state_ngat2 == 1) {
      ...
      //hiện tại 			if ((currentTime - lastDebounceTime) > debounceDelay_mode)
      //			{
      ...
      //= {0}; 					GPIO_InitStruct.Pin = GPIO_PIN_3; 					GPIO_InitStruct.Mode =
      //GPIO_MODE_IT_FALLING; 					GPIO_InitStruct.Pull = GPIO_PULLUP;
      //					HAL_GPIO_Init(GPIOA,
      //&GPIO_InitStruct);
      //				}
  ...
  if (GPIO_Pin == GPIO_PIN_4) {
    ...
    if (state_ngat2 == 1) {
      ...
      //					state_ngat1=1;
      //					GPIO_InitTypeDef GPIO_InitStruct
      //= {0}; 					GPIO_InitStruct.Pin = GPIO_PIN_4; 					GPIO_InitStruct.Mode =
      //GPIO_MODE_IT_FALLING; 					GPIO_InitStruct.Pull = GPIO_PULLUP;
      //					HAL_GPIO_Init(GPIOA,
      //&GPIO_InitStruct);
      //				}
        ...
        if (HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_5) == 0) {
          ...
          if (HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_5) == 0) {
            if (flag_di_qua_nhap_mat_khau) {
              //							num_sao++;
              //							count_state_lcd
              //++; 							flag_chuyen_lcd=1; 							flag_number=10; 							flag_ngat_keypad=1;
            ...
            if ((HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_5) == 0) &&
              ...
              if ((HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_5) == 0) &&
                ...
                if (HAL_GPIO_ReadPin(GPIOA, GPIO_PIN_5) == 0) {
                  if (flag_di_qua_nhap_mat_khau) {
                    //										GPIO_InitTypeDef GPIO_InitStruct =
                    //{0}; 										GPIO_InitStruct.Pin = GPIO_PIN_5;
                    //										GPIO_InitStruct.Mode =
                    //GPIO_MODE_IT_RISING; 										GPIO_InitStruct.Pull = GPIO_PULLUP;
                    //										HAL_GPIO_Init(GPIOA,
                    //&GPIO_InitStruct); 										mode_state1=mode;
                    //										flag_number_state1=flag_number;
                    //										mode_state1++;
                    //										flag_number_state1=10;
                    //										state_ngat2
