...
//char*)so_sanh_chuoi_CMQTT)==0){ 				HAL_UART_Transmit(huart, dataTX1,
//strlen((const char*)dataTX1), 10);
//			}
////			HAL_UART_Transmit(huart, dataTX, strlen(dataTX), 10);
////			HAL_GPIO_TogglePin(GPIOC, GPIO_PIN_13);
//			HAL_UART_Receive_IT(huart, dataRX, sizeof(dataRX));
...
//char*)so_sanh_chuoi_PB_DONE)==0){ 				HAL_UART_Transmit(huart, dataTX1,
//strlen((const char*)dataTX1), 10);
//			}
//			HAL_UART_Receive_IT(huart, dataRX, sizeof(dataRX));
//		}
...
//*dataRX; 					count_data_pass_RX_PAYLOAD++; 					if(*dataRX == '\n'){
//						count_data_pass_RX_PAYLOAD=0;
//						flag_phan_biet_xuong_dong_data =
//1; 						flag_pass_RX_PAYLOAD_next =0; 						flag_pass_all_RX_PAYLOAD =1;
//						flag_pass_RX_PAYLOAD =0;
//						flag_ngat_uart_xong_message=1;
//						sscanf((const char*)message, "%d %d %d %d
//%d %d %d", &led, &quat,
...
//0); 						HAL_TIM_Base_Start_IT(&htim3); 						flag_ngat_uart=1;
//
//
//					}
//
